...
| O1       | 1      | 45,376.75     | 8.32         | 9.40         | 9.05     | 4.45    | 9.00 | 8.45   | [O1-vs-baseline.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O1-vs-baseline.json) |
| O3       | 2      | 44,458 (SE 639) | 8.39 (SE 0.107) | 9.65    | 9.00 (SE 0.05) | 5.12 (SE 0.27) | 8.78 (SE 0.22) | 8.20 (SE 0.10) | [O3-vs-O1.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O3-vs-O1.json) (latest n=2) |
...
| O4v2-post| 1      | 54,849.8      | 9.40 (custom 6-dim) | n/a        | n/a       | n/a       | n/a  | n/a    | [O4v2-post-vs-O4v2-pre.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O4v2-post-vs-O4v2-pre.json) |
| pre-O5   | 1      | 54,438.05     | 8.64         | 9.80         | 9.40     | 5.60    | 9.00 | 8.25   | post-O4 punto de medida (5-dim std rubric, 20Q estándar) |
| O5       | 1      | 61,898.75     | 9.60         | 9.95         | 9.60     | 9.85    | 9.40 | 9.10   | [O5-vs-pre-O5.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O5-vs-pre-O5.json) — composite +0.0606, IMPLEMENT |
| O7       | 2      | 47,617 (SE 871) | 8.64 (SE 0.044) | 8.55    | 8.80 (SE 0.100) | 8.57 (SE 0.425) | 8.80 (SE 0.100) | 8.50 (SE 0.050) | [O7-vs-O5.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O7-vs-O5.json) — REVERT→IMPLEMENT override (O5 n=1 outlier; +0.22 vs original baseline 8.42) |
| O8       | 1      | 46,983          | 8.69            | 8.65    | 8.70            | 8.65            | 8.70            | 8.75            | [O8-vs-O7.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O8-vs-O7.json) — composite +0.0059, IMPLEMENT (0 orphans, neutral by design) |
| O9       | 2      | 47,049 (SE 436) | 8.60 (SE 0.029) | 8.72    | 8.88 (SE 0.025) | 8.03 (SE 0.225) | 8.90 (SE 0.050) | 8.32 (SE 0.275) | [O9-vs-O8.json](../vaults/optimize-my-airbnb-yt/tests/comparisons/O9-vs-O8.json) — composite −0.0075, REVERT (script retained, no code rollback) |

**Histórico de comparaciones**: `vaults/{name}/tests/comparisons/history/<from>-vs-<to>__n<N>.json` preserva cada iteración (n=1, n=2, …) sin sobreescribir. Ver `vaults/optimize-my-airbnb-yt/tests/comparisons/history/O3-vs-O1__n1.json` y `__n2.json`.
...
1. Tras correr `--compare --from <PREV> --to OX`, leer `vaults/{name}/tests/comparisons/OX-vs-<PREV>.json` (latest) y `vaults/{name}/tests/comparisons/history/OX-vs-<PREV>__n<N>.json` (snapshot por iteración)
...
6. Append a [vaults/optimize-my-airbnb-yt/tests/history.md](../vaults/optimize-my-airbnb-yt/tests/history.md)
