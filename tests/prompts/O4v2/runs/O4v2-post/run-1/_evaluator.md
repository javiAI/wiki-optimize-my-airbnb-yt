...
1. SOLO puedes LEER de:
   - /Users/javierabrilibanez/Dev/test/wiki-optimize-my-airbnb-yt/tests/raw-responses/O4v2-post/run-1/Q*.json (las 15 respuestas a evaluar)
...
4. Escribes UN único archivo JSON en EXACTAMENTE esta ruta:
   /Users/javierabrilibanez/Dev/test/wiki-optimize-my-airbnb-yt/tests/raw-responses/O4v2-post/run-1/evaluation.json
...
Guarda el JSON en: /Users/javierabrilibanez/Dev/test/wiki-optimize-my-airbnb-yt/tests/raw-responses/O4v2-post/run-1/evaluation.json
