...
Usage:
    python3 scripts/retrieve.py --query "¿Cómo subo mi precio base?" --lang es
    python3 scripts/retrieve.py --query "pricing strategy" --lang en --top 5
    python3 scripts/retrieve.py --query "PriceLabs occupancy" --lang es --output paths
...
K1 = 1.5
B = 0.75
TOPIC_BOOST = 2.0     # Score multiplier when query token matches a topic
CLAIM_BOOST = 1.5     # Score multiplier for matches in claim vs body
...
def _parse_frontmatter_simple(text: str) -> tuple[dict, str]:
    """Minimal frontmatter parser — extracts claim, topics, lang."""
...
if __name__ == "__main__":
    ...
    p.add_argument("--lang", default=None, help="Language (default: vault primary)")
