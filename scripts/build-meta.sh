...
# 1. videos.md — master table, sorted by published desc
{
  ...
  echo
  echo "> Auto-generated from \`sources/*.md\` frontmatter. Do not edit manually."
...
# 2. Append to log.md
{
  ...
  echo "- Output: \`sources/*.md\` (${COUNT} files)"
...
new_section = (
  "## Fuentes\n\n"
  f"**{count} transcripciones** en `sources/` (último batch: {today}).\n"
